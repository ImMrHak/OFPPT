...
(function (a) { "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (h) { a(h); a.Highcharts = h; return a }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (a) {
    function h(a, b, t, n) { a.hasOwnProperty(b) || (a[b] = n.apply(null, t), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: b, module: a[b] } }))) } a = a ? a._modules : {}; h(a,
    "Extensions/FullScreen.js", [a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Utilities.js"]], function (a, b, t, n) {
        var l = n.addEvent, g = n.fireEvent; n = function () {
            function a(c) {
        ...
        }(); b.Fullscreen = n; l(a, "beforeRender", function () {
            this.fullscreen =
    ...
    [a["Core/Globals.js"]], function (a) {
        return {
            ...
            lang: { viewFullscreen: "View in full screen", exitFullscreen: "Exit from full screen", printChart: "Print chart", downloadPNG: "Download PNG image", downloadJPEG: "Download JPEG image", downloadPDF: "Download PDF document", downloadSVG: "Download SVG vector image", contextButtonTitle: "Chart context menu" }, navigation: {
                ...
                menuStyle: { border: "1px solid #999999", background: "#ffffff", padding: "5px 0" }, menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: a.isTouchDevice ? "14px" : "11px", transition: "background 250ms, color 250ms" }, menuItemHoverStyle: { background: "#335cad", color: "#ffffff" }
            }
        }
        ...
        var l = a.doc, h = b.createElement, z = b.discardElement, g = b.merge, p = b.objectEach, c = {
            ajax: function (a) {
                    ...
                    if (4 === b.readyState) {
                        if (200 === b.status) {
                            if ("blob" !== c.responseType) {
                                ...
                                if ("json" === c.dataType) try { a = JSON.parse(a) } catch (x) { c.error && c.error(b, x); return }
                ...
                var e = h("form", g({ method: "post", action: a, enctype: "multipart/form-data" }, b), { display: "none" }, l.body); p(c, function (a, c) {
                    h("input", { type: "hidden", name: c, value: a }, null,
                    e)
                }); e.submit(); z(e)
            }
        }; ""; return c
        ...
        b = n.defaultOptions; var l = p.doc, t = p.SVG_NS, A = p.win, x = e.addEvent, v = e.css, B = e.createElement, K = e.discardElement,
        C = e.extend, O = e.find, D = e.fireEvent, P = e.isObject, m = e.merge, Q = e.objectEach, y = e.pick, R = e.removeEvent, S = e.uniqueKey, E; (function (b) {
            function n(a) {
                var d = this, c = d.renderer, b = m(d.options.navigation.buttonOptions, a), e = b.onclick, q = b.menuItems, r = b.symbolSize || 12; d.btnCount || (d.btnCount = 0); d.exportDivElements || (d.exportDivElements = [], d.exportSVGElements = []); if (!1 !== b.enabled && b.theme) {
                ...
                var f = this, w = f.options.navigation, G = f.chartWidth, h = f.chartHeight, L = "cache-" + d, m = Math.max(g, q), k = f[L]; if (!k) {
                    f.exportContextMenu = f[L] = k = B("div", { className: d }, {
                        position: "absolute",
                        zIndex: 1E3, padding: m + "px", pointerEvents: "auto"
                ...
                G - c - g - m + "px" : b.left = c - m + "px"; I + q + f.exportMenuHeight > h && "top" !== r.alignOptions.verticalAlign ? b.bottom = h - I - m + "px" : b.top = I + q - m + "px"; v(k, b); v(f.renderTo, { overflow: "" }); v(f.container, { overflow: "" }); f.openMenu = !0; D(f, "exportMenuShown")
            } function U(a) {
            ...
            } function V(a, b) { b = this.getSVGForExport(a, b); a = m(this.options.exporting, a); c.post(a.url, { filename: a.filename ? a.filename.replace(/\//g, "-") : this.getFilename(), type: a.type, width: a.width || 0, scale: a.scale, svg: b }, a.formAttributes) } function W() {
                ...
                function a(b) {
                    var d = {}, f, w; if (r && 1 === b.nodeType && -1 === ca.indexOf(b.nodeName)) {
                        var l = A.getComputedStyle(b, null); var G = "svg" === b.nodeName ? {} : A.getComputedStyle(b.parentNode, null); if (!g[b.nodeName]) {
                            ...
                            g[b.nodeName] = m(A.getComputedStyle(k, null)); "text" === b.nodeName && delete g.text.fill; h.removeChild(k)
                        } for (var q in l) if (p.isFirefox || p.isMS || p.isSafari || Object.hasOwnProperty.call(l, q)) { var t = l[q], n = q; k = f = !1; if (e.length) { for (w = e.length; w-- && !f;) f = e[w].test(n); k = !f } "transform" === n && "none" === t && (k = !0); for (w = c.length; w-- && !k;) k = c[w].test(n) || "function" === typeof t; k || G[n] === t && "svg" !== b.nodeName || g[b.nodeName][n] === t || (M && -1 === M.indexOf(n) ? d[n] = t : t && b.setAttribute(aa(n), t)) } v(b, d); "svg" === b.nodeName &&
                        b.setAttribute("stroke-width", "1px"); "text" !== b.nodeName && [].forEach.call(b.children || b.childNodes, a)
                    }
            ...
            } function fa() { var a = this; a.exporting = { update: function (b, c) { a.isDirtyExporting = !0; m(!0, a.options.exporting, b); y(c, !0) && a.redraw() } }; h.compose(a).navigation.addUpdate(function (b, c) { a.isDirtyExporting = !0; m(!0, a.options.navigation, b); y(c, !0) && a.redraw() }) } function ha() { var a = this; a.isPrinting || (F = a, p.isSafari || a.beforePrint(), setTimeout(function () { A.focus(); A.print(); p.isSafari || setTimeout(function () { a.afterPrint() }, 1E3) }, 1)) } function ia() {
                var a =
        ...
        })(E || (E = {})); b.exporting = m(z.exporting, b.exporting); b.lang = m(z.lang, b.lang); b.navigation = m(z.navigation,
