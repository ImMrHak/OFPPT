...
(function (a) { "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (g) { a(g); a.Highcharts = g; return a }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (a) {
    ...
    a = a ? a._modules : {}; g(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        ...
        function g(a, p) {
        ...
        }); E(b, "render", function () { this.options && this.options.exporting && this.options.exporting.showTable && !this.options.chart.forExport && this.viewData() }); b.prototype.setUpKeyToAxis = function () {
            f.arearange && (f.arearange.prototype.keyToAxis = { low: "y", high: "y" }); f.gantt &&
            (f.gantt.prototype.keyToAxis = { start: "x", end: "x" })
            ...
            var p = this.hasParallelCoordinates, y = this.time, f = this.options.exporting && this.options.exporting.csv || {}, b = this.xAxis, t = {}, d = [], m = [], n = [], z; var l = this.options.lang.exportData; var k = l.categoryHeader, M = l.categoryDatetimeHeader, w = function (q, e, b) {
                if (f.columnHeaderFormatter) { var d = f.columnHeaderFormatter(q, e, b); if (!1 !== d) return d } return q ? q instanceof a ? q.options.title && q.options.title.text || (q.dateTime ? M : k) : c ? {
                    columnTitle: 1 <
                    b ? e : q.name, topLevelColumnTitle: q.name
                } : q.name + (1 < b ? " (" + e + ")" : "") : k
                ...
                return a.data.filter(function (a) { return "undefined" !== typeof a.y && a.name }).length && c && !c.categories && !a.keyToAxis ? a.pointArrayMap && a.pointArrayMap.filter(function (a) { return "x" === a }).length ? (a.pointArrayMap.unshift("x"),
                a.pointArrayMap) : ["x", "y"] : a.pointArrayMap || ["y"]
                ...
                var d = a.xAxis, e = a.options.keys || r(a, d), q = e.length, l = !a.requireSorting && {}, g = b.indexOf(d), B = H(a, e), k; if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    K(h, function (a) { return a[0] === g }) || h.push([g, x]); for (k = 0; k < q;) z = w(a, e[k], e.length), n.push(z.columnTitle || z), c && m.push(z.topLevelColumnTitle || z), k++; var A = {
                        chart: a.chart, autoIncrement: a.autoIncrement, options: a.options,
                        pointArrayMap: a.pointArrayMap
                    }; a.options.data.forEach(function (c, b) { p && (B = H(a, e, b)); var w = { series: A }; a.pointClass.prototype.applyOptions.apply(w, [c]); c = w.x; var h = a.data[b] && a.data[b].name; k = 0; if (!d || "name" === a.exportKey || !p && d && d.hasNames && h) c = h; l && (l[c] && (c += "|" + b), l[c] = !0); t[c] || (t[c] = [], t[c].xValues = []); t[c].x = w.x; t[c].name = h; for (t[c].xValues[g] = w.x; k < q;) b = e[k], h = w[b], t[c][x + k] = v(B.categoryMap[b][h], B.dateTimeValueAxisMap[b] ? y.dateFormat(f.dateFormat, h) : null, h), k++ }); x += k
                }
            }); for (e in t) Object.hasOwnProperty.call(t,
            e) && d.push(t[e]); var e = c ? [m, n] : [n]; for (x = h.length; x--;) { var A = h[x][0]; var D = h[x][1]; var g = b[A]; d.sort(function (a, c) { return a.xValues[A] - c.xValues[A] }); l = w(g); e[0].splice(D, 0, l); c && e[1] && e[1].splice(D, 0, l); d.forEach(function (a) { var c = a.name; g && !J(c) && (g.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), c = y.dateFormat(f.dateFormat, a.x)) : c = g.categories ? v(g.names[a.x], g.categories[a.x], a.x) : a.x); a.splice(D, 0, c) }) } e = e.concat(d); C(this, "exportData", { dataRows: e }); return e
        }; b.prototype.getCSV = function (a) {
            var c =
            "", d = this.getDataRows(), b = this.options.exporting.csv, f = v(b.decimalPoint, "," !== b.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."), k = v(b.itemDelimiter, "," === f ? ";" : ","), l = b.lineDelimiter; d.forEach(function (a, b) { for (var p, y = a.length; y--;) p = a[y], "string" === typeof p && (p = '"' + p + '"'), "number" === typeof p && "." !== f && (p = p.toString().replace(".", f)), a[y] = p; c += a.join(k); b < d.length - 1 && (c += l) }); return c
        }; b.prototype.getTable = function (a) {
            var c = function (a) {
                if (!a.tagName || "#text" === a.tagName) return a.textContent || "";
                var b = a.attributes, d = "<" + a.tagName; b && Object.keys(b).forEach(function (a) { d += " " + a + '="' + b[a] + '"' }); d += ">"; d += a.textContent || ""; (a.children || []).forEach(function (a) { d += c(a) }); return d += "</" + a.tagName + ">"
            ...
            var c = 0, b = [], d = this.options, f = a ? (1.1).toLocaleString()[1] : ".", k = v(d.exporting.useMultiLevelHeaders, !0); a = this.getDataRows(k); var l = k ? a.shift() : null, g = a.shift(), m = function (a, c, b, d) {
                var h = v(d, ""); c = "text" + (c ? " " + c : ""); "number" ===
                typeof h ? (h = h.toString(), "," === f && (h = h.replace(".", f)), c = "number") : d || (c = "empty"); b = F({ "class": c }, b); return { tagName: a, attributes: b, textContent: h }
                ...
                var f = [], h = 0; b = b || c && c.length; var l = 0, e; if (e = k && a && c) {
                    a: if (e = a.length, c.length === e) {
                        for (; e--;) if (a[e] !==
                        c[e]) { e = !1; break a } e = !0
                    } else e = !1; e = !e
                } if (e) { for (e = []; h < b; ++h) { var g = a[h]; var p = a[h + 1]; g === p ? ++l : l ? (e.push(m("th", "highcharts-table-topheading", { scope: "col", colspan: l + 1 }, g)), l = 0) : (g === c[h] ? d.exporting.useRowspanHeaders ? (p = 2, delete c[h]) : (p = 1, c[h] = "") : p = 1, g = m("th", "highcharts-table-topheading", { scope: "col" }, g), 1 < p && g.attributes && (g.attributes.valign = "top", g.attributes.rowspan = p), e.push(g)) } f.push({ tagName: "tr", children: e }) } if (c) {
                    e = []; h = 0; for (b = c.length; h < b; ++h) "undefined" !== typeof c[h] && e.push(m("th",
                    null, { scope: "col" }, c[h])); f.push({ tagName: "tr", children: e })
            ...
            var a = this.getCSV(!0); G(g(a, "text/csv") ||
...
window.addEventListener("load", function (event) {
    document.querySelector(".footer-area").childNodes[1].innerHTML = "&copy; Copyright 2022.All right reserved. Created By <a href=''>Mohamed Hakkou, Saad Qouhafa</a>";
});
